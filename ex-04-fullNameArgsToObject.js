...
function fullNameArgsToObject(name1, name2, name3){
    arrayName1 = name1.split(" ");
    var propertyA = arrayName1[0];
    var valueA = arrayName1[1];

    arrayName2 = name2.split(" ");
    var propertyB = arrayName2[0];
    var valueB = arrayName2[1];

    arrayName3 = name3.split(" ");
    var propertyC = arrayName3[0];
    var valueC = arrayName3[1];

    var person ={
    };

    person[propertyA] = valueA;
    person[propertyB] = valueB;
    person[propertyC] = valueC;
